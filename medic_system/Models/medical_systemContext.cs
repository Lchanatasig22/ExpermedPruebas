...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost;Database=medicossystembd;User Id=sa;Password=1717;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AntecedentesFamiliare>(entity =>
            {
                entity.HasKey(e => e.IdAntecedente)
                    .HasName("PK__antecede__3E014641549A5A60");
                ...
                entity.Property(e => e.ObserAlergias).HasColumnName("obser_alergias");
                ...
                entity.Property(e => e.ObserCirugias).HasColumnName("obser_cirugias");
            ...
            modelBuilder.Entity<Catalogo>(entity =>
            {
                entity.HasKey(e => e.IdCatalogo)
                    .HasName("PK__catalogo__4B673DCA68DBCF54");

                entity.ToTable("catalogo");

                entity.HasIndex(e => e.UuidCatalogo, "UQ__catalogo__C58C4DEBEE4D2E61")
                    .IsUnique();
            ...
            modelBuilder.Entity<Citum>(entity =>
            {
                entity.HasKey(e => e.IdCita)
                    .HasName("PK__cita__6AEC3C0993DA90D7");
            ...
            modelBuilder.Entity<ConsultaDiagnostico>(entity =>
            {
                entity.HasKey(e => e.IdConsultaDiagnostico)
                    .HasName("PK__consulta__D8B1E6BD99A2443D");
            ...
            modelBuilder.Entity<ConsultaImagen>(entity =>
            {
                entity.HasKey(e => e.IdConsultaImagen)
                    .HasName("PK__consulta__43A0875DAC976F0C");
            ...
            modelBuilder.Entity<ConsultaLaboratorio>(entity =>
            {
                entity.HasKey(e => e.IdLaboratorioConsulta)
                    .HasName("PK__consulta__14E40796754E50A0");
            ...
            modelBuilder.Entity<ConsultaMedicamento>(entity =>
            {
                entity.HasKey(e => e.IdConsultaMedicamento)
                    .HasName("PK__consulta__12CF73425E054A4C");
            ...
            modelBuilder.Entity<Consultum>(entity =>
            {
                entity.HasKey(e => e.IdConsulta)
                    .HasName("PK__consulta__6F53588BAD57D321");
                ...
                entity.Property(e => e.AlergiasConsulta).HasColumnName("alergias_consulta");
            ...
            modelBuilder.Entity<Diagnostico>(entity =>
            {
                entity.HasKey(e => e.IdDiagnostico)
                    .HasName("PK__diagnost__1384B745333AE219");
            ...
            modelBuilder.Entity<Especialidad>(entity =>
            {
                entity.HasKey(e => e.IdEspecialidad)
                    .HasName("PK__especial__C1D13763D4407301");

                entity.ToTable("especialidad");

                entity.HasIndex(e => e.UuidEspecialidad, "UQ__especial__A959652189117EB3")
                    .IsUnique();
            ...
            modelBuilder.Entity<Establecimiento>(entity =>
            {
                entity.HasKey(e => e.IdEstablecimiento)
                    .HasName("PK__establec__AFEAEA202A7BAEE5");
            ...
            modelBuilder.Entity<ExamenFisico>(entity =>
            {
                entity.HasKey(e => e.IdExamenFisico)
                    .HasName("PK__examen_f__B5B777B9780B3C38");
            ...
            modelBuilder.Entity<Facturacion>(entity =>
            {
                entity.HasKey(e => e.IdFacturacion)
                    .HasName("PK__facturac__AC4FC89438100ACB");
            ...
            modelBuilder.Entity<Imagen>(entity =>
            {
                entity.HasKey(e => e.IdImagen)
                    .HasName("PK__imagen__27CC2689E1698BE6");

                entity.ToTable("imagen");

                entity.HasIndex(e => e.UuidImagen, "UQ__imagen__448604A0B49A38AB")
                    .IsUnique();
            ...
            modelBuilder.Entity<Laboratorio>(entity =>
            {
                entity.HasKey(e => e.IdLaboratorio)
                    .HasName("PK__laborato__781B42E2D2B52E2E");

                entity.ToTable("laboratorio");

                entity.HasIndex(e => e.UuidLaboratorios, "UQ__laborato__4D3AAC174B5BD369")
                    .IsUnique();
            ...
            modelBuilder.Entity<Localidad>(entity =>
            {
                entity.HasKey(e => e.IdLocalidad)
                    .HasName("PK__localida__9A5E82AA1E2BE76A");
            ...
            modelBuilder.Entity<Medicamento>(entity =>
            {
                entity.HasKey(e => e.IdMedicamento)
                    .HasName("PK__medicame__2588C0325D616C4C");

                entity.ToTable("medicamentos");

                entity.HasIndex(e => e.UuidMedicamento, "UQ__medicame__307E4C1DE6AC52C4")
                    .IsUnique();
            ...
            modelBuilder.Entity<OrganosSistema>(entity =>
            {
                entity.HasKey(e => e.IdOrganosSistemas)
                    .HasName("PK__organos___222F238333D3CF29");
            ...
            modelBuilder.Entity<Paciente>(entity =>
            {
                entity.HasKey(e => e.IdPacientes)
                    .HasName("PK__paciente__D80336DAFBDC8019");
            ...
            modelBuilder.Entity<Pai>(entity =>
            {
                entity.HasKey(e => e.IdPais)
                    .HasName("PK__pais__0941A3A756376ADA");

                entity.ToTable("pais");

                entity.HasIndex(e => e.IsoPais, "UQ__pais__5515698E51A1636B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Perfil>(entity =>
            {
                entity.HasKey(e => e.IdPerfil)
                    .HasName("PK__perfil__1D1C87689E4BC04B");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__usuario__4E3E04AD2EB8D66A");

                entity.ToTable("usuario");

                entity.HasIndex(e => e.EmailUsuario, "UQ__usuario__CD3151FFAB01DB39")
                    .IsUnique();
